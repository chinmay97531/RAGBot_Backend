import { getRequiredFilenameFromMetadata, isReasoningModel, messageToOpenAIRole } from "../utils/misc.js";
	...
	switch (message.role) {
		case "assistant": {
			...
			const response_metadata = {
				...
				...rawResponse.system_fingerprint ? { system_fingerprint: rawResponse.system_fingerprint } : {}
			};
